...
export default async function handler(
	...
	await prisma.restaurant.createMany({
		data: [
			...
			{
				name: "Utsav",
				image: "https://resizer.otstatic.com/v2/photos/xlarge/1/26646742.jpg",
				pricing: PRICING.CHEAP,
				description:
			...
			},
			{
				...
				image: "https://resizer.otstatic.com/v2/photos/xlarge/1/25602522.jpg",
				pricing: PRICING.CHEAP,
				description:
			...
			{
				name: "Sofia",
				image: "https://resizer.otstatic.com/v2/photos/xlarge/1/25558850.jpg",
				pricing: PRICING.EXPENSIVE,
				description:
